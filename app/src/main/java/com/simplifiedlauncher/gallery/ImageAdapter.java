...
public class ImageAdapter extends ArrayAdapter<itemOfImages> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imageView1.setImageBitmap(image.getFirstImage() != null ? image.getFirstImage().getSourceImage() : null);
        imageView1.setTag(image.getFirstImage() != null ? image.getFirstImage().getPath() : null);
        ...
        imageView2.setImageBitmap(image.getSecondImage() != null ? image.getSecondImage().getSourceImage() : null);
        imageView2.setTag(image.getSecondImage() != null ? image.getSecondImage().getPath() : null);
        ...
        imageView3.setImageBitmap(image.getThirdImage() != null ? image.getThirdImage().getSourceImage() : null);
        imageView3.setTag(image.getThirdImage() != null ? image.getThirdImage().getPath() : null);
